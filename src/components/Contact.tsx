    ...
    <section className="py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-playfair mb-4 md:mb-6">Birlikte Çalışalım</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            <div className="p-4 md:p-6 bg-gray-50 rounded-xl">
              <h3 className="text-lg md:text-xl font-playfair mb-3 md:mb-4">Adres</h3>
              <p className="text-gray-600">Nilüfer<br />Bursa, Türkiye</p>
            </div>
            <div className="p-4 md:p-6 bg-gray-50 rounded-xl">
              <h3 className="text-lg md:text-xl font-playfair mb-3 md:mb-4">İletişim</h3>
              <p className="text-gray-600">info@omursosyal.com<br />+90 (555) 123-4567</p>
            </div>
            <div className="p-4 md:p-6 bg-gray-50 rounded-xl">
              <h3 className="text-lg md:text-xl font-playfair mb-3 md:mb-4">Sosyal Medya</h3>
